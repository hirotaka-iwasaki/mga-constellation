...
### Priority 2: ユーザビリティ向上
- [ ] **曲検索機能** - 曲名やアルバム名で検索し、特定の星へジャンプ
- [ ] **外部リンク追加** - 曲カードにYouTube/Spotify/Apple Music等へのリンク
- [ ] **キーボード操作** - 矢印キーで曲ナビゲーション（PC向け）
- [ ] **凡例表示** - 複数星座選択時に線の色とアルバム/ライブ名の対応を表示

### Priority 3: 共有・エンゲージメント機能
- [ ] **URL状態共有** - 選択中の星座をURLパラメータに保存して共有可能に
- [ ] **カスタム星座作成** - 自分の好きな曲を選んでオリジナル星座を作成
- [ ] **星座画像化** - html-to-image/html2canvasでSVGを画像出力、Web Share APIで共有

### Priority 4: 演出・没入感
- [ ] **流れ星エフェクト** - 一定時間操作がないと流れ星が流れる演出
- [ ] **未訪問の星の瞬き** - 微妙なランダムな瞬きで探索を促す
- [ ] **星の脈動アニメーション** - ホバー/タップ時にゆっくり脈動
...
- [ ] **外部リンク** - 曲カードにYouTube/Spotify/Apple Music等へのリンクを追加
